...
ARCH		?=arm64
CROSS_COMPILE	?=/home/alex/Escritorio/kernerls/aarch64-linux-android-4.9/bin/aarch64-linux-android-
...
CC      = /home/alex/Escritorio/kernerls/clang-4639204/bin/clang
CPP		= $(CC) -E
AR		= $(CROSS_COMPILE)ar
NM		= $(CROSS_COMPILE)nm
...
ifeq ($(cc-name),clang)
ifneq ($(CROSS_COMPILE),)
CLANG_TRIPLE    ?=/home/alex/Escritorio/kernerls/clang-4639204/bin/aarch64-linux-gnu-
